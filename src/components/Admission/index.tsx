    ...
    🎓Unlock your future in fashion with us. Join a community of creativity, innovation, and limitless style.🎓
      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap mt-10">
          ...
          <div className="w-full px-4 lg:w-5/12 xl:w-4/12 flex justify-center items-center">
            <div className="flex flex-col items-center justify-center">
              <div style={{ width: '450px', height: '300px' }}>
                {/* Using Next.js Image component */}
                <Image src="/images/admission/add1.jpg" alt="Image 1" layout="responsive" width={300} height={300} />
              </div>
              <div style={{ width: '450px', height: '300px', marginTop: '1rem' }}>
                {/* Using Next.js Image component */}
                <Image src="/images/admission/internship.jpg" alt="Image 2" layout="responsive" width={300} height={300} />
              </div>
            </div>
          </div>
        </div>
